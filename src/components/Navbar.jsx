    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold p-2'>
            ...
            <div className='flex items-center gap-4'>
                <p className='bg-white text-black text-[90%] px-4 py-1 rounded-2xl hidden md:block cursor-pointer'>Explore Premium</p>
                <p className='bg-black py-1 px-3 rounded-2xl text-[90%] cursor-pointer'>Install App</p>
                <p className='bg-purple-700 text-black w-7 h-7 rounded-full flex items-center justify-center'>S</p>
            </div>
        </div>
